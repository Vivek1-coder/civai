...
export default function Home() {
  ...
  return (
    <main className="relative h-screen w-screen  ">
      ...
      <section className="w-full h-full flex flex-col items-center justify-center px-4 pt-14 backgroundContainer text-white overflwo-y-scroll">
        ...
        <div className="flex justify-center items-center flex-wrap">
          {Object.entries(content.articles).map(([articleId, article]) => (
            ...
            >
              ...
              >
                <h3 className="text-lg font-bold z-50 brightness-150 shadow-sm shadow-gray-400 mb-2">Article {articleId}</h3>
